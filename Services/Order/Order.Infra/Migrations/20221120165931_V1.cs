    ...
    public partial class V1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Trạng thái đơn hàng",
                columns: new[] { "Id", "Trạng thái Đơn hàng", "Thông tin đơn hàng" },
                values: new object[,]
                {
                    { 1, "Xác nhận đặt hàng", "Đơn đặt hàng của bạn đã được nhận" },
                    { 2, "Đơn hàng đang chuẩn bị", "Đơn đặt hàng của bạn đã được chuẩn bị" },
                    { 3, "Đang giao hàng", "Đơn hàng của bạn đang được chuyển đến" },
                    { 4, "Đã giao hàng", "Chúc bạn ăn ngon miệng" },
                    { 5, "Đánh giá chúng tôi", "Giúp chúng tôi cải thiện dịch vụ của mình" },
                    { 6, "Hủy Đơn hàng", "Hẹn gặp lại bạn đơn hàng khác" }
                });
